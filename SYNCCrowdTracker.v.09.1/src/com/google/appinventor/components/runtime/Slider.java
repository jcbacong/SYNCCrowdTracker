  ...
  implements SeekBar.OnSeekBarChangeListener
{
  ...
  public void ThumbEnabled(boolean paramBoolean)
  {
    ...
    for (int i = 255;; i = 0)
    {
      if (this.referenceGetThumb) {
        new SeekBarHelper(null).getThumb(i);
      }
  ...
  private class SeekBarHelper
  {
    ...
    public void getThumb(int paramInt)
    {
      Slider.this.seekbar.getThumb().mutate().setAlpha(paramInt);
    }
  }
}


/* Location:              /home/nelmntrx/Desktop/SYNCCrowdTracker/dex2jar-2.0/classes-dex2jar.jar!/com/google/appinventor/components/runtime/Slider.class
