  ...
  implements ComponentContainer
{
  ...
  private String saveFile(java.io.File paramFile, Bitmap.CompressFormat paramCompressFormat, String paramString)
  {
    ...
    //   8: astore 5
    //   10: aload_0
    //   11: getfield 96	com/google/appinventor/components/runtime/Canvas:view	Lcom/google/appinventor/components/runtime/Canvas$CanvasView;
    //   14: invokestatic 197	com/google/appinventor/components/runtime/Canvas$CanvasView:access$1300	(Lcom/google/appinventor/components/runtime/Canvas$CanvasView;)Landroid/graphics/Bitmap;
    //   17: ifnonnull +39 -> 56
    //   20: aload_0
    //   21: getfield 96	com/google/appinventor/components/runtime/Canvas:view	Lcom/google/appinventor/components/runtime/Canvas$CanvasView;
    //   24: invokestatic 200	com/google/appinventor/components/runtime/Canvas$CanvasView:access$1400	(Lcom/google/appinventor/components/runtime/Canvas$CanvasView;)Landroid/graphics/Bitmap;
    //   27: astore 4
    //   29: aload 4
    //   31: aload_2
    //   32: bipush 100
    //   34: aload 5
    //   36: invokevirtual 206	android/graphics/Bitmap:compress	(Landroid/graphics/Bitmap$CompressFormat;ILjava/io/OutputStream;)Z
    //   39: istore 6
    //   41: aload 5
    //   43: invokevirtual 209	java/io/FileOutputStream:close	()V
    //   46: iload 6
    //   48: ifeq +60 -> 108
    //   51: aload_1
    //   52: invokevirtual 215	java/io/File:getAbsolutePath	()Ljava/lang/String;
    //   55: areturn
    //   56: aload_0
    //   57: getfield 96	com/google/appinventor/components/runtime/Canvas:view	Lcom/google/appinventor/components/runtime/Canvas$CanvasView;
    //   60: invokestatic 197	com/google/appinventor/components/runtime/Canvas$CanvasView:access$1300	(Lcom/google/appinventor/components/runtime/Canvas$CanvasView;)Landroid/graphics/Bitmap;
    //   63: astore 4
    //   65: goto -36 -> 29
    //   68: astore_2
    //   69: aload 5
    //   71: invokevirtual 209	java/io/FileOutputStream:close	()V
    //   74: aload_2
    //   75: athrow
    //   76: astore_2
    //   77: aload_0
    //   78: getfield 219	com/google/appinventor/components/runtime/Canvas:container	Lcom/google/appinventor/components/runtime/ComponentContainer;
    //   81: invokeinterface 223 1 0
    //   86: aload_0
    //   87: aload_3
    //   88: sipush 707
    //   91: iconst_1
    //   92: anewarray 225	java/lang/Object
    //   95: dup
    //   96: iconst_0
    //   97: aload_1
    //   98: invokevirtual 215	java/io/File:getAbsolutePath	()Ljava/lang/String;
    //   101: aastore
    //   102: invokevirtual 231	com/google/appinventor/components/runtime/Form:dispatchErrorOccurredEvent	(Lcom/google/appinventor/components/runtime/Component;Ljava/lang/String;I[Ljava/lang/Object;)V
    //   105: ldc 75
    //   107: areturn
    //   108: aload_0
    //   109: getfield 219	com/google/appinventor/components/runtime/Canvas:container	Lcom/google/appinventor/components/runtime/ComponentContainer;
    //   112: invokeinterface 223 1 0
    //   117: aload_0
    //   118: aload_3
    //   119: sipush 1001
    //   122: iconst_0
    //   123: anewarray 225	java/lang/Object
    //   126: invokevirtual 231	com/google/appinventor/components/runtime/Form:dispatchErrorOccurredEvent	(Lcom/google/appinventor/components/runtime/Component;Ljava/lang/String;I[Ljava/lang/Object;)V
    //   129: goto -24 -> 105
    //   132: astore_1
    //   133: aload_0
    //   134: getfield 219	com/google/appinventor/components/runtime/Canvas:container	Lcom/google/appinventor/components/runtime/ComponentContainer;
    //   137: invokeinterface 223 1 0
    //   142: aload_0
    //   143: aload_3
    //   144: sipush 708
    //   147: iconst_1
    //   148: anewarray 225	java/lang/Object
    //   151: dup
    //   152: iconst_0
    //   153: aload_1
    //   154: invokevirtual 234	java/io/IOException:getMessage	()Ljava/lang/String;
    //   157: aastore
    //   158: invokevirtual 231	com/google/appinventor/components/runtime/Form:dispatchErrorOccurredEvent	(Lcom/google/appinventor/components/runtime/Component;Ljava/lang/String;I[Ljava/lang/Object;)V
    //   161: goto -56 -> 105
  ...
  public void DrawCircle(int paramInt1, int paramInt2, float paramFloat, boolean paramBoolean)
  {
    ...
    for (Paint.Style localStyle = Paint.Style.FILL;; localStyle = Paint.Style.STROKE)
    {
      ...
      this.view.canvas.drawCircle(f1 * f2, f3 * f4, paramFloat * f5, localPaint);
  ...
  {
    if ((paramInt > 0) || (paramInt == -2) || (paramInt == -1) || (paramInt <= 64536))
    {
    ...
    extends View
  {
    ...
    public boolean onTouchEvent(MotionEvent paramMotionEvent)
    {
      ...
      Iterator localIterator = Canvas.this.extensionGestureDetectors.iterator();
      while (localIterator.hasNext()) {
        ((Canvas.ExtensionGestureDetector)localIterator.next()).onTouchEvent(paramMotionEvent);
      }
      return true;
    }
    ...
    {
      Canvas.access$602(Canvas.this, paramInt);
      if (this.backgroundDrawable == null) {
    ...
    void setBackgroundImage(String paramString)
    {
      ...
      Canvas.access$502(localCanvas, str);
  ...
  public static abstract interface ExtensionGestureDetector
  {
    ...
    extends GestureDetector.SimpleOnGestureListener
  {
    ...
    {
      float f1 = Math.max(0, (int)(paramMotionEvent1.getX() / Canvas.this.$form().deviceDensity()));
      float f2 = Math.max(0, (int)(paramMotionEvent1.getY() / Canvas.this.$form().deviceDensity()));
      paramFloat1 /= 1000.0F;
      paramFloat2 /= 1000.0F;
  ...
  class MotionEventParser
  {
    ...
    void parse(MotionEvent paramMotionEvent)
    {
      int i = Canvas.this.Width();
      int j = Canvas.this.Height();
      float f1 = Math.max(0.0F, (int)paramMotionEvent.getX() / Canvas.this.$form().deviceDensity());
      float f2 = Math.max(0.0F, (int)paramMotionEvent.getY() / Canvas.this.$form().deviceDensity());
      ...
      case 2: 
        ...
        } while ((!this.isDrag) && (Math.abs(f1 - this.startX) < 15.0F) && (Math.abs(f2 - this.startY) < 15.0F));
        this.isDrag = true;
        this.drag = true;
        paramMotionEvent = Canvas.this.sprites.iterator();
        while (paramMotionEvent.hasNext())
...
/* Location:              /home/nelmntrx/Desktop/SYNCCrowdTracker/dex2jar-2.0/classes-dex2jar.jar!/com/google/appinventor/components/runtime/Canvas.class
