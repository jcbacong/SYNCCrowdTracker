...
@DesignerComponent(category=ComponentCategory.LAYOUT, description="Top-level component containing all other components in the program", showOnPalette=false, version=18)
@SimpleObject
  ...
  implements Component, ComponentContainer, HandlesEventDispatching, ViewTreeObserver.OnGlobalLayoutListener
{
    ...
    this.androidUIHandler.post(new Runnable()
    {
      public void run()
      {
        if ((Form.this.frameLayout != null) && (Form.this.frameLayout.getWidth() != 0) && (Form.this.frameLayout.getHeight() != 0))
        {
          ...
          for (;;)
          {
            Form.access$402(Form.this, true);
    ...
    throws java.lang.Throwable
  {
    // Byte code:
    //   0: aload_1
    //   1: invokevirtual 662	java/lang/Object:getClass	()Ljava/lang/Class;
    //   4: ldc_w 937
    //   7: aconst_null
    //   8: checkcast 939	[Ljava/lang/Class;
    //   11: invokevirtual 943	java/lang/Class:getMethod	(Ljava/lang/String;[Ljava/lang/Class;)Ljava/lang/reflect/Method;
    //   14: astore_2
    //   15: ldc 66
    //   17: new 274	java/lang/StringBuilder
    //   20: dup
    //   21: invokespecial 275	java/lang/StringBuilder:<init>	()V
    //   24: ldc_w 945
    //   27: invokevirtual 281	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   30: aload_1
    //   31: invokevirtual 302	java/lang/Object:toString	()Ljava/lang/String;
    //   34: invokevirtual 281	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   37: invokevirtual 285	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   40: invokestatic 291	android/util/Log:i	(Ljava/lang/String;Ljava/lang/String;)I
    //   43: pop
    //   44: aload_2
    //   45: aload_1
    //   46: aconst_null
    //   47: checkcast 947	[Ljava/lang/Object;
    //   50: invokevirtual 953	java/lang/reflect/Method:invoke	(Ljava/lang/Object;[Ljava/lang/Object;)Ljava/lang/Object;
    //   53: pop
    //   54: return
    //   55: astore_1
    //   56: ldc 66
    //   58: new 274	java/lang/StringBuilder
    //   61: dup
    //   62: invokespecial 275	java/lang/StringBuilder:<init>	()V
    //   65: ldc_w 955
    //   68: invokevirtual 281	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   71: aload_1
    //   72: invokevirtual 958	java/lang/SecurityException:getMessage	()Ljava/lang/String;
    //   75: invokevirtual 281	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   78: invokevirtual 285	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   81: invokestatic 291	android/util/Log:i	(Ljava/lang/String;Ljava/lang/String;)I
    //   84: pop
    //   85: return
    //   86: astore_1
    //   87: return
    //   88: astore_1
    //   89: ldc 66
    //   91: new 274	java/lang/StringBuilder
    //   94: dup
    //   95: invokespecial 275	java/lang/StringBuilder:<init>	()V
    //   98: ldc_w 960
    //   101: invokevirtual 281	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   104: aload_1
    //   105: invokevirtual 961	java/lang/reflect/InvocationTargetException:getMessage	()Ljava/lang/String;
    //   108: invokevirtual 281	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   111: invokevirtual 285	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   114: invokestatic 291	android/util/Log:i	(Ljava/lang/String;Ljava/lang/String;)I
    //   117: pop
    //   118: aload_1
    //   119: invokevirtual 965	java/lang/reflect/InvocationTargetException:getTargetException	()Ljava/lang/Throwable;
    //   122: athrow
...
/* Location:              /home/nelmntrx/Desktop/SYNCCrowdTracker/dex2jar-2.0/classes-dex2jar.jar!/com/google/appinventor/components/runtime/Form.class
