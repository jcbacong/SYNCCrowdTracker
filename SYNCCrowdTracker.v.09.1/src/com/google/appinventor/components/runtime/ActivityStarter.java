  ...
  implements ActivityResultListener, Component, Deleteable
{
  ...
  private Intent buildActivityIntent()
  {
    ...
    if (this.dataUri.length() != 0)
    {
      ...
      localIntent = new Intent(this.action, (Uri)localObject1);
      label35:
    ...
    for (;;)
    {
      ...
      localObject1 = this.extras.toArray();
      int j = localObject1.length;
      int i = 0;
      while (i < j)
      {
        Object localObject2 = (YailList)localObject1[i];
        String str = ((YailList)localObject2).getString(0);
        localObject2 = ((YailList)localObject2).getString(1);
        if ((str.length() != 0) && (((String)localObject2).length() != 0))
        {
          Log.i("ActivityStarter", "Adding extra (pairs), key = " + str + " value = " + (String)localObject2);
...
/* Location:              /home/nelmntrx/Desktop/SYNCCrowdTracker/dex2jar-2.0/classes-dex2jar.jar!/com/google/appinventor/components/runtime/ActivityStarter.class
