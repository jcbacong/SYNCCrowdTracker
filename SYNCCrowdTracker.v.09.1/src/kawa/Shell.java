...
public class Shell
{
  ...
  static
  {
    ...
    Class[] arrayOfClass7 = boolClasses;
    Boolean localBoolean7 = Boolean.FALSE;
    Class[] arrayOfClass8 = boolClasses;
    Boolean localBoolean8 = Boolean.TRUE;
    Class[] arrayOfClass9 = xmlPrinterClasses;
    Object localObject1 = portArg;
    Object[] arrayOfObject = { "html", "gnu.xml.XMLPrinter", "make", xmlPrinterClasses, portArg, "html" };
    Class[] arrayOfClass10 = xmlPrinterClasses;
    Object localObject2 = portArg;
    Class[] arrayOfClass11 = httpPrinterClasses;
    Object localObject3 = portArg;
    Class[] arrayOfClass12 = noClasses;
    formats = new Object[][] { { "scheme", "gnu.kawa.functions.DisplayFormat", "getSchemeFormat", arrayOfClass1, localBoolean1 }, { "readable-scheme", "gnu.kawa.functions.DisplayFormat", "getSchemeFormat", arrayOfClass2, localBoolean2 }, { "elisp", "gnu.kawa.functions.DisplayFormat", "getEmacsLispFormat", arrayOfClass3, localBoolean3 }, { "readable-elisp", "gnu.kawa.functions.DisplayFormat", "getEmacsLispFormat", arrayOfClass4, localBoolean4 }, { "clisp", "gnu.kawa.functions.DisplayFormat", "getCommonLispFormat", arrayOfClass5, localBoolean5 }, { "readable-clisp", "gnu.kawa.functions.DisplayFormat", "getCommonLispFormat", arrayOfClass6, localBoolean6 }, { "commonlisp", "gnu.kawa.functions.DisplayFormat", "getCommonLispFormat", arrayOfClass7, localBoolean7 }, { "readable-commonlisp", "gnu.kawa.functions.DisplayFormat", "getCommonLispFormat", arrayOfClass8, localBoolean8 }, { "xml", "gnu.xml.XMLPrinter", "make", arrayOfClass9, localObject1, null }, arrayOfObject, { "xhtml", "gnu.xml.XMLPrinter", "make", arrayOfClass10, localObject2, "xhtml" }, { "cgi", "gnu.kawa.xml.HttpPrinter", "make", arrayOfClass11, localObject3 }, { "ignore", "gnu.lists.VoidConsumer", "getInstance", arrayOfClass12 }, { null } };
  }
...
/* Location:              /home/nelmntrx/Desktop/SYNCCrowdTracker/dex2jar-2.0/classes-dex2jar.jar!/kawa/Shell.class
