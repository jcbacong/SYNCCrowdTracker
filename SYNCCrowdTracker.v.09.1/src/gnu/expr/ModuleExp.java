    ...
    throws SyntaxException
  {
      ...
      do
      {
        do
        {
          ...
          try
          {
            ...
            localObject1 = localObject3;
            paramEnvironment = localThread;
            paramURL = localThread.getContextClassLoader();
            paramCompilation = paramURL;
            localObject1 = paramURL;
            paramEnvironment = localThread;
            localThread.setContextClassLoader(localClass.getClassLoader());
            paramCompilation = localThread;
          }
          catch (Throwable paramEnvironment)
          {
            do
            {
              ...
              {
                paramEnvironment = null;
                paramURL = paramCompilation;
                paramCompilation = paramEnvironment;
              }
              localObject1 = paramURL;
              paramEnvironment = paramCompilation;
        ...
        } while (paramCompilation == null);
        paramCompilation.setContextClassLoader(paramURL);
        return paramOutPort;
      } while (paramCompilation == null);
      paramCompilation.setContextClassLoader(paramURL);
      return localClass;
    ...
    finally
    {
      ...
      if (paramEnvironment != null) {
        paramEnvironment.setContextClassLoader((ClassLoader)localObject1);
      }
    }
  }
...
/* Location:              /home/nelmntrx/Desktop/SYNCCrowdTracker/dex2jar-2.0/classes-dex2jar.jar!/gnu/expr/ModuleExp.class
