...
public abstract class Language
{
  ...
  static
  {
    ...
    String[] arrayOfString1 = { "emacs", "elisp", "emacs-lisp", ".el", "gnu.jemacs.lang.ELisp" };
    String[] arrayOfString2 = { "xslt", "xsl", ".xsl", "gnu.kawa.xslt.XSLT" };
    languages = new String[][] { { "scheme", ".scm", ".sc", "kawa.standard.Scheme" }, { "krl", ".krl", "gnu.kawa.brl.BRL" }, { "brl", ".brl", "gnu.kawa.brl.BRL" }, arrayOfString1, { "xquery", ".xquery", ".xq", ".xql", "gnu.xquery.lang.XQuery" }, { "q2", ".q2", "gnu.q2.lang.Q2" }, arrayOfString2, { "commonlisp", "common-lisp", "clisp", "lisp", ".lisp", ".lsp", ".cl", "gnu.commonlisp.lang.CommonLisp" } };
  }
...
/* Location:              /home/nelmntrx/Desktop/SYNCCrowdTracker/dex2jar-2.0/classes-dex2jar.jar!/gnu/expr/Language.class
